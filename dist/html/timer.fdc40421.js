...
})({"3wI3Z":[function(require,module,exports) {
"use strict";
...
const options = {
    ...
    onClose (selectedDates) {
        ...
        if (selectedDates[0] < actualDate) (0, _notiflixDefault.default).Notify.failure("Please select a future date");
        else {
            if (mainInterval) {
...
},{"notiflix":"fuMq1","flatpickr":"llQu5","flatpickr/dist/flatpickr.min.css":"eVN6V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fuMq1":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"eVN6V":[function() {},{}]},["3wI3Z","9Okty"], "9Okty", "parcelRequired7c6")
