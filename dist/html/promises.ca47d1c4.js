...
})({"4GKoE":[function(require,module,exports) {
"use strict";
...
form.addEventListener("submit", (event)=>{
    ...
    const delay1 = Number.parseInt(firstDelay.value);
    const step = Number.parseInt(stepDelay.value);
    // асинхронний цикл, де є кілька варіантів вирішення задачі
    for(let i = 0; i < amount.value; i++)createPromise(i + 1, delay1 + step * i).then(({ position , delay  })=>{
...
},{}]},["4GKoE","cvs10"], "cvs10", "parcelRequired7c6")
